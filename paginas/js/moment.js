!  función ( e , t ) {
    "objeto"  ==  typeof  exportaciones  &&  "indefinido"  ! =  typeof  módulo  ?  módulo . exportaciones  =  t ( )  : "función" == typeof definir && definir . amd ? definir ( t ) : e . momento = t ( )
} ( esto , función ( ) {
    "uso estricto" ;
    var  e , i ;
    función  f ( )  {
        volver  e . aplicar ( nulo , argumentos )
    }
    función  o ( e )  {
        volver  e  instanceof  matriz  ||  "[matriz de objetos]"  ===  Objeto . prototipo . toString . llamar ( e )
    }
    función  u ( e )  {
        return  null  ! =  e  &&  "[object Object]"  ===  Object . prototipo . toString . llamar ( e )
    }
    función  m ( e , t ) {
        return  Object . prototipo . hasOwnProperty . llamar ( e , t )
    }
    función  l ( e )  {
        if  ( Object . getOwnPropertyNames ) return 0 === Objeto . getOwnPropertyNames ( e ) . longitud ;
        para  ( var  t  en  e )
            if  ( m ( e , t ) ) return ;
        volver  1
    }
    ...
    función  h ( e )  {
        volver  "número"  ==  typeof  e  ||  "[Número de objeto]"  ===  Objeto . prototipo . toString . llamar ( e )
    }
    función  a ( e )  {
        return  e  instancia de  Fecha  ||  "[Fecha del objeto]"  ===  Objeto . prototipo . toString . llamar ( e )
    }
    función  d ( e , t ) {
        para  ( var  n  =  [ ] , s = 0 ; s < e . longitud ; ++ s ) n . empujar ( t ( e [ s ] , s ) ) ;
        volver  n
    }
    función  c ( e , t ) {
        para  ( var  n  en  t ) m ( t , n ) && ( e [ n ] = t [ n ] ) ;
        return  m ( t , "toString" ) && ( e . toString = t . toString ) , m ( t , "valueOf" ) && ( e . valueOf = t . valueOf ) , e
    }
    función  _ ( e , t , n , s ) {
        volver  xt ( e , t , n , s , ! 0 ) . utc ( )
    }
    función  y ( e )  {
        devolver  nulo  ==  e . _pf  &&  ( e . _pf  =  {
            vaciar : ! 1 ,
            UnusedTokens :  [ ] ,
            unusedInput :  [ ] ,
            desbordamiento : - 2 ,
    ...
    function G(e) {
        var  t , n , s = { } ;
        para  ( n  en  e ) m ( e , n ) && ( t = V ( n ) ) && ( s [ t ] = e [ n ] ) ;
        volver  s
    }
    var  E  =  { } ;
    función  A ( e , t ) {
    ...
    función  j ( e )  {
        devuelve  e  %  4  ==  0  &&  e  %  100  ! =  0  ||  e  %  400  ==  0
    }
    función  I ( e )  {
        devolver  e  <  0  ?  Matemáticas . ceil ( e ) || 0 : Matemáticas . piso ( e )
    }
    función  Z ( e )  {
        var  t  =  + e ,
            n  =  0 ;
    ...
    función  z ( t , n ) {
         función de retorno ( e )  {
            devolver  nulo  ! =  e  ?  ( q ( esto , t , e ) , f . updateOffset ( esto , n ) , esto ) : $ ( esto , t )
        }
    }
    función  $ ( e , t ) {
        volver  e . isValid ( ) ? e . _d [ "obtener" + ( e . _isUTC ? "UTC" : "" ) + t ] ( ) : NaN
    }
    función  q ( e , t , n ) {
        e . isValid ( ) && ! isNaN ( n ) && ( "Año completo" === t && j ( e . año ( ) ) && 1 === e . mes ( ) && 29 === e . fecha ( ) ? ( n = Z ( n ) , e . _d [ "establecer" + ( e                       . _isUTC  ?  "UTC"  : "" ) + t ] ( n , e . Mes ( ) , xe ( n , e . Mes ( ) ) ) ) : e . _d [ "establecer" + ( e . _isUTC ? "UTC" : "" ) + t ] ( n ) )
    }
    var  B , J = / \ d / ,
        Q  =  / \ d \ d / ,
        X  =  / \ d {3} / ,
        ...
        le  =  / Z | [+ -] \ d \ d:? \ d \ d / gi ,
        él  =  / Z | [+ -] \ d \ d (? ::? \ d \ d)? / gi ,
        de  =  / [0-9] {0,256} ['az \ u00A0- \ u05FF \ u0700- \ uD7FF \ uF900- \ uFDCF \ uFDF0- \ uFF07 \ uFF10- \ uFFEF] {1,256} | [\ u0600- \ u06FF \ /] {1,256} (\ s *? [\ U0600- \ u06FF] {1,256}) {1,2} / i ;
    function  ce ( e , n , s ) {
        B [ e ] = O ( n ) ? n : función ( e , t ) {
            devolver  e  &&  s  ?  s  : n
        }
    }
    función  fe ( e , t ) {
        volver  m ( B , e ) ? B [ e ] ( t . _Strict , t . _Locale ) : nueva expresión regular ( me ( e . Reemplazar ( "\\" , "" ) . Reemplace ( / \\ (\ [) | \\ (\]) | \ [([^ \] \ [] *) \] | \\ (.) / g , function ( e , t , n , s , i ) {
            volver  t  ||  n  ||  s  ||  yo
        } ) ) )
    }
    función  me ( e )  {
        volver  e . reemplazar ( /[-\/\\^$*+?.()|[\]{}]/g , "\\ $ &" )
    }
    B  =  { } ;
    var  _e  =  { } ;
    función  ye ( e , n ) {
    ...
    función  Mt ( e , t , n , s , i , r ) {
        var  a  =  [ función ( e )  {
            var  t  =  parseInt ( e , 10 ) ; {
                si  ( t  <=  49 ) devuelve 2e3 + t ;
                si  ( t  <=  999 ) devuelve 1900 + t
            }
            volver  t
        } ( e ) , Ne . indexOf ( t ) , parseInt ( n , 10 ) , parseInt ( s , 10 ) , parseInt ( i , 10 ) ] ;
        volver  r  &&  a . empujar ( parseInt ( r , 10 ) ) , a
    }
    función  Dt ( e )  {
        var  t , n , s , i , r = pt . exec ( e . _i . reemplazar ( / \ ([^)] * \) | [\ n \ t] / g , "" ) . reemplace ( / (\ s \ s +) / g , "" ) . reemplazar ( / ^ \ s \ s * / , "" ) . reemplazar ( / \ s \ s * $ / , "" ) ) ;
        si  ( r )  {
